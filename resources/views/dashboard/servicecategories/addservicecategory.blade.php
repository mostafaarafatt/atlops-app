    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3" method="POST" action="{{ route('addServiceCategorydone') }}">
                        @csrf
                        <div class="col-md-4">
                            <label for="validationDefault01" class="form-label"> اسم الخدمة</label>
                            <input placeholder="ادخل اسم الخدمة" type="text" name="service_name" class="form-control"
                                value="" required>
