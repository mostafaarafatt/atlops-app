    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3" method="POST" action="{{ route('addCategory') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-4">
                            <label for="validationDefault01" class="form-label"> اسم الفئة</label>
                        ...
                        <div class="mb-3">
                            ...
                            <label class="form-label " for="inputImage">اختار صورة الفئة</label>
