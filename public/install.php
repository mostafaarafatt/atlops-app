...
<html>
    <head>
        ...
        <title>Scaffolding Installer</title>
    ...
    <body>
    	<div class="master">
            <div class="box">
                <div class="header">
                    <h1 class="header__title">Scaffolding Installer</h1>
                </div>
                <div class="main">
                	$msg
               	</div>
...
sudo chmod ug+rwx ' . $root_dir_no_slash . '</textarea><br/>');
}
...
if (!empty($app_key)) {
    ...
    header('Location: ' . getSubdirectory() . 'installer');
} else {
    showPermissionsError();
}
exit();
